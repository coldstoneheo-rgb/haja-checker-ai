...
const PHASES: { day: string; title: string; status: "done" | "now" | "todo" }[] = [
  ...
  { day: "D-5 (5/6)", title: "Service Worker 오프라인 · 사진 3종 가이드", status: "todo" },
  { day: "D-4 (5/7)", title: "권한 · 에러 · 사진 품질 경고", status: "todo" },
  { day: "D-3 (5/8)", title: "단위 테스트 · iOS Safari 호환성", status: "todo" },
  { day: "D-2 (5/9)", title: "1차 실기기 모의 점검", status: "todo" },
